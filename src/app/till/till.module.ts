...
@NgModule({
  declarations: [PayFormComponent, IndexComponent, SpendingsListComponent, VouchersListComponent, ReportsComponent, UserProductionComponent, ReportByBankComponent, CreditNotesListComponent, SpendingFormComponent],
